...
**Look at R-014.** No rate limiting on the public provider directory API — deliberately **accepted**, not mitigated. The data is public by design and the exposure doesn't justify the remediation cost. The Risk Acceptance sheet records ACC-014: Elena Voss, COO, accepted the Low residual risk on 2026-03-12 under delegated authority for public-data operational risks. The record sets monitoring conditions, a July review and December expiry. The person, authority and decision are fictional scenario content.
